...
'fruitServers': ['apricot.intranet', 'banana.intranet', 'blackberry.intranet',
...
'fruitNames': ['Apricot', 'Banana', 'Blackberry', 'Clementine', 'Grape',
'Guava', 'Kiwi', 'Lemon', 'Lime', 'Mango', 'Orange', 'Papaya', 'Pear',
'Pigface', 'Plum', 'Pumpkin', 'Strawberry', 'Training'],

'fruitPics': [
  'apricot', 'banana', 'blackberry', 'clementine', 'grape', 'guava', 'kiwi',
  'lemon', 'lime', 'mango', 'orange', 'papaya', 'pear', 'pigface', 'plum',
  'pumpkin', 'strawberry', 'training'
],

'veggieServers': ['arugula.intranet', 'atlas01.intranet', 'contemporary.intranet',
...
'veggieNames': ['Arugula', 'Atlas01', 'Contemporary', 'Dreamcatcher', 'DX',
...
'veggiePics': [
  'arugula', 'atlas01', 'contemporary', 'dreamcatcher', 'dx', 'eggplant',
  'finding', 'ghidorah01', 'ginger', 'growth', 'honeysuckle', 'intl', 'kaiju',
  'leek', 'logistics01', 'logistics02', 'logistics03', 'mcperson', 'mobileqa',
